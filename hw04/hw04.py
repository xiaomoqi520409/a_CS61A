...
def balanced(m):
    ...
    if is_planet(m):
        ...
        tonque_left= length(left(m))*total_mass(left_end)
        tonque_right= length(right(m))*total_mass(right_end)
        return tonque_left==tonque_right and balanced(left_end) and balanced(right_end)
